...
export default [
    ...
    createConfing_def({ input: `src/index.ts`, output: `dist/es6/dom/index${minAppendix}.mjs`, tsconfig: './tsconfig.json' }),
    createConfing_def({ input: 'src/vdom-builder/index.ts', output: `dist/es6/builder/index${minAppendix}.mjs`, tsconfig: './tsconfig-builder.json' }),
